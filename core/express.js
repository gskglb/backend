...
let publicFolder = path.normalize(path.join(config.app.rootPath, "public"));
let viewsFolder = path.normalize(path.join(config.app.rootPath, "views"));
...
function initMiddleware(app) {
	...
	if (config.isDevMode()) {
		...
		logger.info("********************Express :  Middleware Initialization done ")
...
function initViewEngine(app) {
	...
	logger.info("********************Express :  View engine Initialization done ")
...
function initSession(app, db) {
	...
	logger.info("********************Express :  Session Initialization done ")
...
function initHelmetHeaders(app) {
	...
	logger.info("********************Express :  Middleware Helmet Initialization done ")
